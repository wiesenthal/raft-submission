...
class SetFitModel(PyTorchModelHubMixin):
    ...
    def __init__(
        ...
        model_head: Optional[Union[SetFitHead, LogisticRegression, RandomForestClassifier]] = None,
    ...
    def _from_pretrained(
        ...
        non_differentiable_model_head: Optional[Union[LogisticRegression, RandomForestClassifier]] = LogisticRegression,
        normalize_embeddings: bool = False,
        **model_kwargs,
    ) -> "SetFitModel":
        ...
        if model_head_file is not None:
            ...
            if use_differentiable_head:
                ...
                clf = non_differentiable_model_head(**head_params)
